<section>
    ...
    <form method="post"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label for="name" class="theme-title block text-sm font-semibold text-[#3b2818] mb-1.5">
                    Nombre
                </label>
            ...
            <div>
                <label for="email" class="theme-title block text-sm font-semibold text-[#3b2818] mb-1.5">
                    Correo electrónico
                </label>
        ...
        <div>
            <label for="photo" class="theme-title block text-sm font-semibold text-[#3b2818] mb-1.5">
                Foto de perfil
            </label>

            <label for="photo"
                   class="theme-soft flex items-center justify-between gap-4 w-full rounded-2xl border border-dashed border-[#d8c6a3] bg-[#fbf8f3] px-4 py-3 cursor-pointer hover:bg-[#f3efe7] transition">

                <div class="flex items-center gap-4">
                    <div class="w-10 h-10 rounded-xl bg-[#5b3a1e] text-white flex items-center justify-center">
