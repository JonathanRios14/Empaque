<section>
    ...
    <form method="post"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                <label for="name" class="block text-sm font-semibold text-[#3b2818] mb-2">
                    Nombre
                </label>
            ...
            <div>
                <label for="email" class="block text-sm font-semibold text-[#3b2818] mb-2">
                    Correo electrónico
                </label>
        ...
        <div>
    <label for="photo" class="block text-sm font-semibold text-[#3b2818] mb-2">
        Foto de perfil
    </label>

    <label for="photo"
           class="flex items-center justify-between gap-4 w-full rounded-2xl border border-dashed border-[#d8c6a3] bg-[#fbf8f3] px-5 py-4 cursor-pointer hover:bg-[#f3efe7] transition">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p id="photoFileName" class="text-xs text-gray-500 mt-1">
                    JPG, PNG o WEBP · máximo 2 MB
                </p>
            </div>
        </div>

        <span class="hidden md:inline-flex px-4 py-2 rounded-xl bg-white border border-[#e5d8c7] text-[#5b3a1e] text-xs font-semibold">
            Buscar archivo
        </span>
    </label>
