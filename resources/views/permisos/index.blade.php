        ...
        <section class="p-4 lg:p-6">
            <div class="w-full max-w-[1600px] mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                    ...
                    <div class="theme-card theme-shadow bg-white rounded-2xl border border-[#e5d8c7] shadow-sm p-5">
                        <p class="theme-text text-sm text-gray-500">
                            Total de permisos
                        </p>

                        <h2 class="theme-title text-3xl font-bold text-[#5b3a1e] mt-1">
                            {{ $permissions->count() }}
                        </h2>
                    </div>
                    ...
                    <div class="theme-card theme-shadow bg-white rounded-2xl border border-[#e5d8c7] shadow-sm p-5">
                        ...
                        <h2 class="theme-title text-lg font-bold text-[#5b3a1e] mt-2">
                            Roles y accesos
                        </h2>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            @foreach ($grupos as $nombreGrupo => $permisosGrupo)
                                @if ($permisosGrupo->count())
                                    ...
                                    <div class="theme-soft rounded-2xl bg-[#f9f5ee] border border-[#e5d8c7] theme-border p-5">
                                        ...
                                        <div class="space-y-2">
                                            @foreach ($permisosGrupo as $permission)
                                                ...
                                                <div class="theme-card flex items-center justify-between bg-white rounded-xl border border-[#eee3d5] theme-border px-4 py-2">
                                                    <div class="flex items-center gap-2">
                                                        <span class="w-2 h-2 rounded-full bg-[#5b3a1e]"></span>

                                                        <span class="theme-title text-sm text-gray-700">
                                                            {{ $permission->name }}
                                                        </span>
                                                    </div>
